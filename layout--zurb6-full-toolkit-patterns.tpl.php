...
/**
 * @file
 * This is a set of patterns for building layouts. Comment/remove or uncomment the regions you desire into Zurb Full Toolkit and rename.
 *
 * Variables:
...
<?php if ($content['header']): ?>
    <header class="l-header" role="banner" aria-label="<?php print t('Site header'); ?>">
      <div class="row expanded ">
        <div class="small-12 medium-expand column l-header-inner">
...
<div class="layout--zurb6-full-toolkit-patterns <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <div class="l-wrapper">
    <div class="l-wrapper-inner">
      ...
      <?php if ($content['top']): ?>
        <div class="row expanded l-top" role="region">
          <div class="column l-top-inner">
      ...
      <?php if ($messages): ?>
        <div class="l-messages" role="status" aria-label="<?php print t('Status messages'); ?>">
          <div class="column l-messages-inner">
            <?php print $messages; ?>
          </div>
        </div>
      <?php endif; ?>
      ...
      <?php if ($content['content']): ?>
        <main class="row expanded l-content" role="main" aria-label="<?php print t('Main content'); ?>">
          <div class=" small-12 medium-expand column l-content-inner">
      ...
      <div class="row expanded small-uncollapse large-uncollapse">
          <?php if ($content['content']): ?>
            <main class="small-12 medium-8 large-9 small-order-1 medium-order-1 l-content" role="main" aria-label="<?php print t('Main content'); ?>">
              <div class="column l-content-inner">
                <?php print $content['content']; ?>
              </div>
            </main>
          <?php endif; ?>
          ...
          <?php if ($content['sidebar']): ?>
            <aside class="small-12 medium-4 large-3 small-order-2 medium-order-2 l-sidebar l-sidebar1" role="complementary" aria-label="<?php print t('Complementary information to ' . $title); ?>">
              <div class="column l-sidebar-inner">
...
<!-- content sidebar sidebar -->
    <div class="row expanded small-uncollapse large-uncollapse">
      ...
      <?php if ($content['statement1']): ?>
        <div class="row expanded small-collapse medium-collapse large-collapse l-statement l-statement1" role="region">
          <div class="small-12 column l-statement-inner">
      ...
      <?php if ($content['statement2']): ?>
        <div class="row expanded small-collapse medium-collapse large-collapse l-statement l-statement2" role="region">
          <div class="small-12 column l-statement-inner">
      ...
      <?php if ($content['statement3']): ?>
        <div class="row expanded small-collapse medium-collapse large-collapse l-statement l-statement3" role="region">
          <div class="small-12 column l-statement-inner">
      ...
      <?php if ($content['secondary1']): ?>
        <div class="row expanded small-collapse medium-collapse large-collapse l-secondary l-secondary1" role="region">
          <div class="small-12 column l-secondary-inner">
      ...
      <!-- secondary sidebar -->
      <div class="row expanded small-uncollapse large-uncollapse" style="background-color: blue;">
      ...
      <?php if ($content['bottom']): ?>
        <div class="row expanded small-collapse medium-collapse large-collapse l-bottom" role="region">
          <div class="small-12 column l-bottom-inner">
      ...
      <?php if ($content['calltoaction']): ?>
        <footer class="row expanded align-center align-middle text-center small-collapse medium-collapse large-collapse l-calltoaction" role="secondary" aria-label="<?php print t('Action to take'); ?>">
          <div class="small-12 medium-12 column l-calltoaction-inner">
...
</div><!-- /.layout--zurb6-full-toolkit-patterns -->

  <?php if ($content['footer']): ?>
    <footer class="row expanded l-footer" role="contentinfo" aria-label="<?php print t('Footer navigation'); ?>">
      <div class="small-12 medium-12 large-12 column l-footer-inner">
